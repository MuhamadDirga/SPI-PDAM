<div class="easyui-layout" data-options="fit:true">
	...
	<div data-options="region:'center'" style="padding:5px;">
		<table id="dgAuditor" style="width:100%;height:100%;" title="Auditor" rownumbers="true" pagination="false">
			<thead>
				<tr>
					<th data-options="field:'No_PKPT'" width="20%">No PKPT</th>
					<th data-options="field:'NIP'" editor="{type:'textbox'}" width="20%">NIP</th>
	    ...
	    <div id="jendelaTambahAuditor" class="easyui-window" title="Modal Window" data-options="modal:true,closed:true,iconCls:'icon-print'" style="width:500px; min-height:200px; padding:5px;">
		</div>
	</div>
</div>
<script type="text/javascript">
	function formatAction(value,row,index){
			if (row.editing){
				...
				var d = ' | <a href="#" onclick="if(confirm(&quot;Yakin akan dihapus?&quot;)){resetrow(&quot;'+row.No_PKPT+'&quot;,&quot;'+row.NIP+'&quot;)}">Hapus</a> ';
				return e+d;
			}
	}
</script>
